...
const navlinks = {
  overview: [
    ...
    },
    {
      ...
      link: "/deposit",
      icon: (
        <ArrowFatLineDown size={iconSize} className="sidebar__menu-item-icon" />
      ),
    },
    {
      name: "Withdrawal",
      link: "/withdrawal",
      icon: (
        <ArrowFatLineUp size={iconSize} className="sidebar__menu-item-icon" />
      ),
    },
    {
      name: "History",
      link: "/history",
      icon: (
        <CalendarDots size={iconSize} className="sidebar__menu-item-icon" />
      ),
    },
  ],
  system: [
